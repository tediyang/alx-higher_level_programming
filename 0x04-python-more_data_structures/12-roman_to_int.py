...
def roman_to_int(roman_string):
    ...
    # Create a list where individual characters of the roman strings will be added and the values will be summed to number.
    r_list, number = [], 0
    ...
    # If it is the first character of the string then don't chrck any conditions.
        ...
        # check the last character added to confirm it is a complex roman number (IV, XL etc.) or not.
        else:
